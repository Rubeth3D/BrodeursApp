...
VALUES ('Pierre Dupuis', 1001, 16, 1, 'Inactif'),
...
FROM professeur p
WHERE u.type_utilisateur = 'P'
    AND u.id_utilisateur = p.utilisateur_id_utilisateur;
--Rajoute le id_etudiant dans la table utilisateur
UPDATE utilisateur u
SET etudiant_id_etudiant = e.id_etudiant
FROM etudiant e
WHERE u.type_utilisateur = 'E'
    AND u.id_utilisateur = e.utilisateur_id_utilisateur;
-- Insertion Session
...
VALUES -- Professeur 1 : Jean Dupuis (ID Professeur = 1)
    (
        'CS101',
        'Introduction aux concepts fondamentaux de l informatique, y compris la programmation de base et les algorithmes.',
        1,
